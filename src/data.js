  ...
  persons: [
    {
      avatar: <Avatar1Img />,
      name: 'Rahul Tiwari',
      occupation: 'Manager of The India News of Times',
      message:
...
export const footer = {
  social: [
    ...
    },
    {
      ...
      href: 'https://instagram.com/ll_pin2_sharma11_ll?igshid=ZGUzMzM3NWJiOQ==',
    },
    {
      icon: <IoLogoGithub />,
    ...
    {
      icon: <IoLogoFacebook />,
      href: 'https://www.facebook.com/profile.php?id=100022136775983&mibextid=ZbWKwL',
    },
  ],
  copyright: 'SharmaShop 2023 - All rights reserved.',
};
